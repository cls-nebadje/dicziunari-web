# Django settings for dicziunari project.
#
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(TOP_DIR, 'db.sqlite3'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'mmdwewkzx8kut#x-u+vt9kn+ddb4q0-mc+942=$h7b=9xkd!f2'
...
ROOT_URLCONF = 'dicziunari-web.urls'
